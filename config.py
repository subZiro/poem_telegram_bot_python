...
class Config:
	...
	# db files
	DB_DIR = 'sqlite_db'
	DB_FILE = 'poems_db_v134.db'
	DB_FILE_OLD = 'poems_db.db'
	...
	commands = {  
	    ...
	    'authors': 'Получить информацию о хранимых авторах',
	    'poems': 'Получить информацию о хранимых стихотворениях',
	    'myinfo': 'Получить статистику по прочитанным стихотворениям',
	    'restart': 'Сброс всей статистии',
	    'end': 'Удаление бота, завершение работы с ботом',
	    'setauthor': 'Выбрать автора',  #TODO
